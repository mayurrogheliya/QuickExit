...
import 'package:quick_exit/screens/Rector_Screens/RectorHistory.dart';
import 'package:quick_exit/screens/Rector_Screens/RectorIssueGatePass.dart';
import 'package:quick_exit/screens/Rector_Screens/RectorRequests.dart';

class RectorNavBar extends StatefulWidget {
  const RectorNavBar({super.key});

  @override
  State<RectorNavBar> createState() => _RectorNavBarState();
}

class _RectorNavBarState extends State<RectorNavBar> {
  int currIndex = 0;
  List pages = [
    RectorIssueGatePass(),
    RectorRequests(),
